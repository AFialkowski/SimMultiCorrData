#' @title Plot Theoretical Power Method Probability Density Function and Target PDF of External Data
#'
...
#' @param method the method used to generate the continuous variable y = p(z).  "Fleishman" uses a third-order polynomial
