...
#'     \code{k_pois} Poisson variables. It extends the method of Amatya & Demirtas (2015) to continuous variables generated using
#'     Headrick's fifth-order polynomial transformation.  Here, the intermediate correlation between Z1 and Z2 (where Z1 is
...
#'     between Y1 and Z1.  The function is used in \code{\link[SimMultiCorrData]{findintercorr}} and
