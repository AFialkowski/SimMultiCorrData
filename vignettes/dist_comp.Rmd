...
Headrick & Kowalchuk (2007, <DOI:10.1080/10629360600605065>) outlined a general method for comparing a simulated distribution $\Large Y$ to a given theoretical distribution $\Large Y^*$.  Note that these could easily be modified for comparison to an empirical vector of data:
...
Look at a summary of the distribution.
```{r}
