...
#'     2 categories) and \code{k_pois} Poisson variables. It extends the method of Amatya & Demirtas (2015) to ordinal - Poisson pairs.
...
#'     and the normal variable used to generate it (see Demirtas & Hedeker, 2011).  The function is used in
