#' @title Headrick Transformation Lagrangean Constraints for Lower Boundary of Standardized Kurtosis
#'
#' @description This function gives the first-order conditions of the multi-constraint Headrick Transformation Lagrangean expression
...
#'     in \code{\link[SimMultiCorrData]{calc_lower_skurt}}.  The partial derivatives are described in Headrick (2002), but he does not provide
